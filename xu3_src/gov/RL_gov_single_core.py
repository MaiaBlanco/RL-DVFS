...
Includes branch misses per Kinstruction, IPC, and data memory accesses per Kinstruction for each core, 
plus core temp and big cluster power. (BMPKI, IPC, MPKI, celsius, watts)
...
def get_raw_state():	
	...
	# bmiss/Kinst, IPC, dmem_accesses/Kinst, temp, power
	raw_state = [diffs[0,0]/diffs[0,2], diffs[0,2]/diffs[0,1], diffs[0,3]/diffs[0,2], T[0],P]
	return raw_state
